...
for wearable screens to be useful, they need to last time! With your CPU & GPU from home computer doing the heavy lifting, glasses running ghostty in zBoot could potentially be the
answer for text based comms. We may still need to add wayland for a GUI, "though have you tried 'Brow6el'?"
