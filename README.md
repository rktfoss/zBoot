...
- **A live environment to fall back into** In the event of a crash, you'll have full access to all files & network connection to search and replace corrupted files via terminal. 
